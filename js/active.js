window.addEventListener('DOMContentLoaded',function(){
  ...
  //map link
    ...
    function todayList(){   
        ...
        liToday += "<li class='item item"+idx+"'>";
        liToday += "<div class='thumb'><a class='linkA link"+idx+"' href='"+url+"'><img src='"+thumb+"' alt='"+en+"'></a></div>";
    ...
    //drag
    (() => {
        const item = document.querySelectorAll('.today-list .item');
        const listBox = document.querySelector('.today-list .data-wrap');
        ...
        function endPos() {
            ...
            setTimeout(function () { ulToday.style = "transform:translateX(" + (-420 * idx) + "px);"; }, 100);
